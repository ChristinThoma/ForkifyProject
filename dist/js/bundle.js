...
/*!*********************************!*\
  !*** ./src/js/models/recipe.js ***!
  \*********************************/
/*! exports provided: OneRecipe */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"OneRecipe\", function() { return OneRecipe; });\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\nvar axios = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n\nvar OneRecipe = /*#__PURE__*/function () {\n  function OneRecipe(query) {\n    _classCallCheck(this, OneRecipe);\n\n    this.query = query;\n  }\n\n  _createClass(OneRecipe, [{\n    key: \"getAPIrecipe\",\n    value: function () {\n      var _getAPIrecipe = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(inputID) {\n        var response;\n        return regeneratorRuntime.wrap(function _callee$(_context) {\n          while (1) {\n            switch (_context.prev = _context.next) {\n              case 0:\n                _context.prev = 0;\n                this.query.params.r = inputID;\n                _context.next = 4;\n                return axios(this.query);\n\n              case 4:\n                response = _context.sent;\n                console.log(response);\n                this.responseData = response.data[0];\n                console.log(this.responseData);\n                _context.next = 13;\n                break;\n\n              case 10:\n                _context.prev = 10;\n                _context.t0 = _context[\"catch\"](0);\n                alert(_context.t0);\n\n              case 13:\n              case \"end\":\n                return _context.stop();\n            }\n          }\n        }, _callee, this, [[0, 10]]);\n      }));\n\n      function getAPIrecipe(_x) {\n        return _getAPIrecipe.apply(this, arguments);\n      }\n\n      return getAPIrecipe;\n    }()\n  }]);\n\n  return OneRecipe;\n}();\n\n//# sourceURL=webpack:///./src/js/models/recipe.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return AllRecipes; });\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\nvar axios = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n\nvar AllRecipes = /*#__PURE__*/function () {\n  function AllRecipes(query) {\n    _classCallCheck(this, AllRecipes);\n\n    this.query = query;\n  }\n\n  _createClass(AllRecipes, [{\n    key: \"getAPIrecipe\",\n    value: function () {\n      var _getAPIrecipe = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n        var response;\n        return regeneratorRuntime.wrap(function _callee$(_context) {\n          while (1) {\n            switch (_context.prev = _context.next) {\n              case 0:\n                _context.prev = 0;\n                _context.next = 3;\n                return axios(this.query);\n\n              case 3:\n                response = _context.sent;\n                console.log(response);\n                this.responseData = response.data.hits;\n                console.log(this.responseData);\n                _context.next = 12;\n                break;\n\n              case 9:\n                _context.prev = 9;\n                _context.t0 = _context[\"catch\"](0);\n                alert(_context.t0);\n\n              case 12:\n              case \"end\":\n                return _context.stop();\n            }\n          }\n        }, _callee, this, [[0, 9]]);\n      }));\n\n      function getAPIrecipe() {\n        return _getAPIrecipe.apply(this, arguments);\n      }\n\n      return getAPIrecipe;\n    }()\n  }]);\n\n  return AllRecipes;\n}();\n\n\n\n//# sourceURL=webpack:///./src/js/models/search.js?");
...
/*!************************************!*\
  !*** ./src/js/views/searchView.js ***!
  \************************************/
/*! exports provided: getSearchInput, clearSearchField, printRecipesUI, addRotatingArrow */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getSearchInput\", function() { return getSearchInput; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"clearSearchField\", function() { return clearSearchField; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"printRecipesUI\", function() { return printRecipesUI; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"addRotatingArrow\", function() { return addRotatingArrow; });\n/* harmony import */ var _base__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./base */ \"./src/js/views/base.js\");\nfunction _createForOfIteratorHelper(o) { if (typeof Symbol === \"undefined\" || o[Symbol.iterator] == null) { if (Array.isArray(o) || (o = _unsupportedIterableToArray(o))) { var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError(\"Invalid attempt to iterate non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.\"); } var it, normalCompletion = true, didErr = false, err; return { s: function s() { it = o[Symbol.iterator](); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it[\"return\"] != null) it[\"return\"](); } finally { if (didErr) throw err; } } }; }\n\nfunction _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === \"string\") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === \"Object\" && o.constructor) n = o.constructor.name; if (n === \"Map\" || n === \"Set\") return Array.from(n); if (n === \"Arguments\" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }\n\nfunction _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }\n\n// export fun   -> indexedDB.js fun(recipeArr)\n// \\fun (arg):\n//    for recipe in args:\n//       add recipe to html page\n// Create a function, which takes an array of recipes and prints each object on hmtl page\n\nfunction getSearchInput() {\n  var inputValue = document.querySelector(\".search__field\").value;\n  return inputValue;\n}\nfunction clearSearchField() {\n  document.querySelector(\".search__field\").value = \"\";\n}\nfunction printRecipesUI(recipesArr) {\n  var offset = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;\n  var length = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 5;\n  removeArrow();\n  clearSearchResults(); // if (document.querySelector(\".results__list\").innerText = \"\") {\n\n  var newRecipesArr = pagination(recipesArr, offset, length);\n  console.log(\"new array: \", newRecipesArr);\n\n  for (var i = 0; i < newRecipesArr.length; i++) {\n    var text = createHtmlRecipe(newRecipesArr[i]);\n    document.querySelector(\".results__list\").insertAdjacentHTML(\"beforeend\", text); // }\n  }\n}\n\nfunction clearSearchResults() {\n  var el = document.querySelector(\".results__list\");\n\n  while (el.firstElementChild) {\n    console.log(\"something random\");\n    el.removeChild(el.firstElementChild);\n  }\n}\n\n;\n\nfunction createHtmlRecipe(rec) {\n  var idRec = rec.recipe.uri;\n  var text = \"<li>\\n    <a class=\\\"results__link results__link--active\\\" href=#\".concat(idRec, \" \\n        <figure class=\\\"results__fig\\\">\\n            <img src=\").concat(rec.recipe.image, \" alt=\\\"Test\\\" width=\\\"100\\\" height=\\\"100\\\" style=\\\"border-radius:50%\\\">\\n        </figure>\\n        <div class=\\\"results__data\\\">\\n            <h4 class=\\\"results__name\\\">\").concat(shortenDescription(rec.recipe.label, 20), \"</h4>\\n            <p class=\\\"results__author\\\">\").concat(shortenDescription(rec.recipe.source), \"</p>\\n        </div>\\n    </a>\\n</li>\"); // We added # at href, because we need it for our hashchange event in index.js, has gives an label to the element which will be shown in addressbar after click\n\n  return text;\n}\n\nfunction shortenDescription(text) {\n  var limit = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 40;\n  var textArray = text.split(\" \");\n  var newText = \"\";\n\n  var _iterator = _createForOfIteratorHelper(textArray),\n      _step;\n\n  try {\n    for (_iterator.s(); !(_step = _iterator.n()).done;) {\n      var el = _step.value;\n\n      if (newText.length + el.length <= limit) {\n        newText += \" \" + el;\n      }\n    }\n  } catch (err) {\n    _iterator.e(err);\n  } finally {\n    _iterator.f();\n  }\n\n  return newText + \"...\";\n}\n\nfunction addRotatingArrow() {\n  document.querySelector(\".results\").insertAdjacentHTML(\"afterbegin\", _base__WEBPACK_IMPORTED_MODULE_0__[\"rotatingIcon\"]);\n}\n\nfunction removeArrow() {\n  var arrow = document.querySelector(\".loader\");\n\n  if (arrow) {\n    arrow.parentNode.removeChild(arrow.parentNode.firstElementChild);\n  }\n}\n\nfunction pagination(arr, offset, length) {\n  var start = (offset - 1) * length;\n  var end = offset * length; // console.log(arr.slice(offset, (offset + length)))\n\n  var condition;\n\n  if (start === 0) {\n    condition = 1;\n  } else if (end >= arr.length) {\n    condition = 3;\n  } else {\n    condition = 2;\n  }\n\n  removeButtons();\n  addPageButtons(offset, condition);\n  return arr.slice(start, end);\n}\n\nfunction removeButtons() {\n  var el = document.querySelector(\".results__pages\");\n\n  while (el.firstElementChild) {\n    el.removeChild(el.firstElementChild);\n  }\n} //3 scenarios (1.You are page 1 , Button shows page 2, 2. YOu are in middle of 2 pages (2 Buttons indication previous and following), 3. You are on last page (Button shos precious page), use Offset to navigate through pages)\n\n\nfunction addPageButtons(offset, condition) {\n  offset = parseInt(offset);\n  var buttonNext = \"<button class=\\\"btn-inline results__btn--next\\\" data-offset=\".concat(offset, \">\\n    <span>Page \").concat(offset + 1, \" </span>\\n    <svg class=\\\"search__icon\\\">\\n        <use href=\\\"img/icons.svg#icon-triangle-right\\\"></use>\\n    </svg>\\n</button>\");\n  var buttonPrev = \"<button class=\\\"btn-inline results__btn--prev\\\" data-offset=\".concat(offset, \">\\n<svg class=\\\"search__icon\\\">\\n    <use href=\\\"img/icons.svg#icon-triangle-left\\\"></use>\\n</svg>\\n<span>Page \").concat(offset - 1, \"</span>\\n</button>\");\n\n  if (condition === 1) {\n    document.querySelector(\".results__pages\").insertAdjacentHTML(\"beforeend\", buttonNext);\n  }\n\n  if (condition === 2) {\n    document.querySelector(\".results__pages\").insertAdjacentHTML(\"beforeend\", buttonNext);\n    document.querySelector(\".results__pages\").insertAdjacentHTML(\"beforeend\", buttonPrev);\n  }\n\n  if (condition === 3) {\n    document.querySelector(\".results__pages\").insertAdjacentHTML(\"beforeend\", buttonPrev);\n  }\n} // Create function to print the recipe you clicked on\n\n//# sourceURL=webpack:///./src/js/views/searchView.js?");
